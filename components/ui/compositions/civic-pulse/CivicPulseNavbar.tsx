  ...
  return (
    ...
    >
      <div className="flex h-16 items-center justify-between px-margin-mobile md:px-gutter" id="tpl-components-ui-compositions-civic-pulse-civic-pulse-navbar-l26-c7">
        ...
        <div className="flex items-center gap-2 sm:gap-3" id="tpl-components-ui-compositions-civic-pulse-civic-pulse-navbar-l34-c9">
          <LanguageSwitcher />
          <Link
            id="navbar-digital-speech"
            href="/speech"
            className="hidden h-8 items-center justify-center rounded-full border border-outline-variant px-3 text-sm font-semibold text-primary transition-colors hover:bg-surface-container-low focus-visible:ring-2 focus-visible:ring-primary sm:inline-flex sm:px-4"
          >
          ...
          <a
            id="navbar-volunteer"
            href="#volunteer"
            className="inline-flex h-8 items-center justify-center rounded-full bg-primary px-4 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-primary sm:px-5"
          >
