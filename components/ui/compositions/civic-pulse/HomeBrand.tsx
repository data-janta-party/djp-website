  ...
  return (
    ...
    >
      <div
        ...
        data-home-step
        className="story-snap-panel relative flex h-svh min-h-svh w-full items-center px-margin-mobile md:px-gutter"
      >
      ...
      <div
        id="home-panel-os"
        data-home-step
        className="story-snap-panel relative flex h-svh min-h-svh w-full flex-col items-center justify-center px-margin-mobile text-center md:px-gutter"
      >
